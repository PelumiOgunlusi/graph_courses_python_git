...
```{python}
counties["percentage_fbn"] = ( counties['foreign_born_num']/ counties["pop_20"] * 100).round(1)
counties = counties.sort_values(by="percentage_fbn", ascending=False)
counties
```
...
```{python}
counties["foreign_born_pct_gt_30"] = counties["percentage_fbn"] > 30.0
